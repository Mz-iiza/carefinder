...
function Navbar() {
  ...
  return (
    <>
      <nav
        className="bg-[#191d24] h-20 text-white flex w-full items-center justify-between p-2 lg:px-8 fixed top-0 left-0 right-0 z-50 shadow-sm"
        aria-label="Global"
      >
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5">
            <Link href="/" className="flex justify-center items-center">
              <h2 className="pl-2 flex text-lg text-bold uppercase">
                C
                <TbActivityHeartbeat
